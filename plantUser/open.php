...
//  echo $date;
    $replyId = $postId;
    $query = "INSERT INTO posts(emailId,comment,postdate, replyId) VALUES('$emailId', '$comment', '$date', '$replyId')";
...
<body>
        ...
        <div class="feed w-100 h-100 d-flex flex-column">
            ...
            <?php 
                 $sql4 = "SELECT * FROM posts WHERE postid = '$postId' ";
                 ...
                 if ($result4 ->num_rows > 0) {
                    ...
                    <div class="card w-100 mx-5 my-4">
                        ...
                        <div class="card-body">
                            <p class="card-text text-success m-0 my-2">By '.$by.' at '.$at.'</p>
            ...
            <?php
                $sql5 = "SELECT * FROM posts WHERE replyId = $postId";
                    ...
                    while ($row = mysqli_fetch_assoc($result5)) 
                    {
                        ...
                        <div class="card w-75 mx-5 my-4 d-flex flex-column justify-content-center">
                            <div class="card-body w-75">
                                <h5 class="card-title text-danger fs-6">By '.$emailId.' at '.$userdate.'</h5>
