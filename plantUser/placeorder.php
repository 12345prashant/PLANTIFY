...
$sql = "SELECT firstName, lastName FROM users WHERE emailId = '$emailId'";
...
<body>
    ...
    <div class="d-flex justify-content-center m-5 flex-column">
        ...
        <p class="fw-bolder fs-4 d-flex flex-wrap justify-content-center text-success">
            If any query, contact at : +91 1234567890 or support.plantify@gmail.com
        </p>
    </div>
    ...
    <div class="d-flex w-100 justify-content-center w-100">
        <div class="d-flex flex-column w-50">
            ...
            <div class="d-flex m-2 justify-content-between">
                ...
                <span class="fw-medium" id="orderDate"> 21-09-2023</span>
            </div>
            <div class="d-flex m-2 justify-content-between">
                <span class="fw-medium">Name:</span>
                <span class="fw-medium"><?php echo $firstName . " " . $lastName; ?></span>
            </div>
            <div class="d-flex m-2 justify-content-between">
                <span class="fw-medium">Contact:</span>
                <span class="fw-medium"><?php echo $emailId; ?></span>
            </div>
