    ...
    <div class=" mx-5 px-5 py-3 cardcontainer">
        ...
        <!-- <div id="Tools" class="tabcontent">
            <div class="d-flex flex-wrap justify-content-around p-3">
                ...
                if ($result2->num_rows > 0) {
                    while ($row = mysqli_fetch_assoc($result2)) {
                        echo '<div class="card card2" style="width: 15rem; height: 25rem;">
                            <img src="../seller/' . $row['imagePath'] . '" class="card-img-top w-100 h-75" alt="...">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <h5 class="card-title justify-content-center d-flex">' . $row['productName'] . '</h5>
                                    <h5 class="card-title justify-content-center d-flex">' . $row['price'] . '</h5>
                                </div>
                                <p class="card-text">' . $row['description'] . '</p>
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="cart.php" class="btn link-success fw-bold text-capitalize">Add to <i class="fa-solid fa-cart-plus"></i></a>
                                    <a href="buynow.php?productId=' . $row['productId'] . '" class="btn link-success fw-bold text-capitalize">Buy Now <i class="fa-solid fa-truck"></i></a>
                                </div>
                            </div>
                        </div>';
                    }
        ...
        <!-- <div id="Fertilizers" class="tabcontent">
            <div class="d-flex flex-wrap justify-content-around p-3">
                <?php
                $sql2 = "SELECT * FROM products where category='Fertilizers' ";
                $result2 = mysqli_query($conn, $sql2);
                    ...
                    while ($row = mysqli_fetch_assoc($result2)) {
                        echo '<div class="card card2" style="width: 15rem; height: 25rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="cart.php" class="btn link-success fw-bold text-capitalize">Add to <i class="fa-solid fa-cart-plus"></i></a>
                                    <a href="buynow.php" class="btn link-success fw-bold text-capitalize">Buy Now <i class="fa-solid fa-truck"></i></a>
                                </div>
                            </div>
                        </div>';
                    }
